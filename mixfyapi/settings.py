"""
Django settings for mixfyapi project.
...
SECRET_KEY = 'django-insecure-y=r^$oa4a(mb1sjoz6j!k5zu79oq8qlkr=3hza2l-e+-e%&z8d'
...
WSGI_APPLICATION = 'mixfyapi.wsgi.application'
